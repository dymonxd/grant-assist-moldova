...
| 03-01-04 | 01 | 1 | MATCH-08 | unit | `npx vitest run src/app/actions/__tests__/matching.test.ts -x` | W0 | pending |
...
| Profile sidebar responsive behavior | MATCH-06 | Sidebar to collapsible transition is CSS-driven | Desktop: verify sidebar visible; Mobile: verify collapsible panel with tap-to-expand |
